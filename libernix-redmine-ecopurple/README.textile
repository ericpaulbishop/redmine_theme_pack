h1. The @ecopurple@ theme.

h2.  Summary

The @libernix-redmine-ecopurple@ project aims to provide a professional looking purple-styled appearance to an installation of "Redmine":http://www.redmine.org/ 
...
Now you would have a newly created folder called @libernix-redmine-ecopurple@, 2 others underneath it as follows:
* @redmine/public/themes/libernix-redmine-ecopurple/stylesheets/@ - contains the CSS stylesheets,
* @redmine/public/themes/libernix-redmine-ecopurple/images/@ - contains PNG images/icons for logo purposes.
...
<pre>
$  popd
$  chown  -R lighttpd:lighttpd redmine/public/themes/libernix-redmine-ecopurple
$  chmod 755 redmine/public/themes/libernix-redmine-ecopurple
</pre>

Now within Redmine, go to Administration ➤ Settings ➤ Display, and change the theme to @Libernix-redmine-ecopurple@.
...
* Feel free to report all issues on the "libernix-redmine-ecopurple":http://github.com/rajkrish/libernix-redmine-ecopurple  Github project site for this package.  
