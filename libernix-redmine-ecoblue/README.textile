h1. The @ecoblue@ theme.

h2.  Summary

The @libernix-redmine-ecoblue@ project aims to provide a professional looking blue-styled appearance to an installation of "Redmine":http://www.redmine.org/ 
...
* Feel free to report all issues on the "libernix-redmine-ecoblue":http://github.com/rajkrish/libernix-redmine-ecoblue  Github project site for this package.  
