h1. The @ecoyellow@ theme.

h2.  Summary

The @libernix-redmine-ecoyellow@ project aims to provide a professional looking yellow-styled appearance to an installation of "Redmine":http://www.redmine.org/ 
...
Now you would have a newly created folder called @libernix-redmine-ecoyellow@, 2 others underneath it as follows:
* @redmine/public/themes/libernix-redmine-ecoyellow/stylesheets/@ - contains the CSS stylesheets,
* @redmine/public/themes/libernix-redmine-ecoyellow/images/@ - contains PNG images/icons for logo purposes.
...
<pre>
$  popd
$  chown  -R lighttpd:lighttpd redmine/public/themes/libernix-redmine-ecoyellow
$  chmod 755 redmine/public/themes/libernix-redmine-ecoyellow
</pre>

Now within Redmine, go to Administration ➤ Settings ➤ Display, and change the theme to @Libernix-redmine-ecoyellow@.
...
* Feel free to report all issues on the "libernix-redmine-ecoyellow":http://github.com/rajkrish/libernix-redmine-ecoyellow  Github project site for this package.  
